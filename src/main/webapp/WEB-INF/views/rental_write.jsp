...
<link rel="stylesheet"
    ...
    <link href="/attend/${path}/resources/css/rental_write.css" rel="stylesheet">
    <script
...
<body>
    <div class="main">
        ...
        <section>
            ...
            <form action="/attend/rentalwrite" method="post">
            	<div class="head"><b>학생학번</b><input type="text" name="studentnum" placeholder="학생 학번을 입력해주세요" required></div>
           		<div class="head"><b>학생이름</b><input type="text" name="studentname" placeholder="학생 이름을 입력해주세요" required></div>
